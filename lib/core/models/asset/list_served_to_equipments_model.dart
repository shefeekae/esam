class ListServingToAssetsWithLatestDataModel {
  ListServingToAssetsWithLatestData? listServingToAssetsWithLatestData;

  ListServingToAssetsWithLatestDataModel(
      {this.listServingToAssetsWithLatestData});

  ListServingToAssetsWithLatestDataModel.fromJson(Map<String, dynamic> json) {
...
class ListServingToAssetsWithLatestData {
  ...
  ListServingToAssetsWithLatestData.fromJson(Map<String, dynamic> json) {
    if (json['assets'] != null) {
      assets = <ServedToEquipment>[];
      json['assets'].forEach((v) {
        assets!.add(ServedToEquipment.fromJson(v));
      });
    }
...
class ServedToEquipment {
  ...
  ServedToEquipment.fromJson(Map<String, dynamic> json) {
