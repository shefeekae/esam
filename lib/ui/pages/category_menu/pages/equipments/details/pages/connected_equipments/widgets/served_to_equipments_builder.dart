...
class ServedToEquipmentsPagedGridBuilder extends StatefulWidget {
  const ServedToEquipmentsPagedGridBuilder({
    super.key,
  ...
  @override
  State<ServedToEquipmentsPagedGridBuilder> createState() =>
      _ServedToEquipmentsPagedGridBuilderState();
}

class _ServedToEquipmentsPagedGridBuilderState
    extends State<ServedToEquipmentsPagedGridBuilder> {
  ...
  void initState() {
    pagingController.addPageRequestListener((pageKey) {
      AssetsPaginationServices().getPaginatedServedByORServedToAssetsList(
        ...
        connectedEquipment: ConnectedEquipments.servedToEquipments,
      );
    });
