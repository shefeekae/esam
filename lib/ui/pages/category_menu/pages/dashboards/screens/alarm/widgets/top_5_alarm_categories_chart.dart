...
class Top5AlarmCategoriesChart extends StatelessWidget {
    ...
    return QueryWidget(
        ...
        builder: (result, {fetchMore, refetch}) {
          ...
          if (result.isLoading) {
            return Skeletonizer(
                enabled: true,
                child: buildLayout(chartData, [], start, end, context));
          }
  ...
  Padding buildLayout(List<ChartData> chartData, List<ChartData> othersList,
    ...
    return Padding(
      ...
      child: BgContainer(
        title: "Top 5 Alarm Categories based on All Alarms",
